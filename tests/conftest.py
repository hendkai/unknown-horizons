...
def pytest_configure(config):
	...
	config.addinivalue_line('markers', 'gui_test: mark test as requiring the GUI')
	install_fife_mock()
...
#
# It must run before collection imports game or test code, otherwise modules can
# keep a reference to the real fife package. pytest_configure runs early enough
# for modern pytest versions and replaces the removed pytest_namespace hook.
